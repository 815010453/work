    ...
    try:
        ...
        if task == 1:
            ...
            for i in k_1:
                ...
                j += 1
                with open('outputs/task1_sample.txt', 'a', encoding='utf-8') as f:
                    for v in indices:
                        f.write(str(v))
                        f.write('\n')
        elif task == 2:
                    ...
                    if len(eq_id) > 1:
                        ...
                        for id_index in range(first_index, last_index):
                            if indices[id_index] > indices[id_index + 1]:
                                ...
                                indices[id_index + 1] = temp
                print('t1:', time.time() - query_start)
                with open('outputs/task2_sample.txt', 'a', encoding='utf-8') as f:
                    for v in indices:
                        f.write(str(v))
                        f.write('\n')
                j += 1
            ...
            for temp_coord1 in test_coord1:
                ...
                j += 1
                # write file
                with open('outputs/task3_sample.txt', 'a', encoding='utf-8') as f:
                    for v in real_res:
                        f.write(str(v))
                        f.write('\n')
        elif task == 4:
            ...
            for temp_coord1 in test_coord1:
                ...
                j += 1
                # write file
                with open('outputs/task4_sample.txt', 'a', encoding='utf-8') as f:
            ...
            for d in dis:
                ...
                j += 1
                # write file
                with open('outputs/task5_sample.txt', 'a', encoding='utf-8') as f:
                    for v in real_datetime_res:
                        f.write(str(v))
                        f.write('\n')
